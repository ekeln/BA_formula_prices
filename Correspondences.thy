...
chapter \<open>Characterizing Equivalences\<close>

text \<open>In this chapter we introduce the modal-logical characterizations $\mathcal{O}_X$ of the various equivalences and link them to the HML sublanguages $\mathcal{O}_{e_X}$ determined 
...
the colloquial definitions via trace sets/the relational definition of bisimilarity.\<close>
